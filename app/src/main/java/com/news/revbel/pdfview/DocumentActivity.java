package com.news.revbel.pdfview;
...
{
    private final String APP = "Библиотека";
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		closeButton = (FloatingActionButton)findViewById(R.id.close_button);
	...
	public void toggleUI() {
		if (controlView.getVisibility() == View.VISIBLE) {
			...
			if (layoutButton.getVisibility() == View.VISIBLE || outlineButton.getVisibility() == View.VISIBLE) {
